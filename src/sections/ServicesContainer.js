...
const ServicesContainer = () => {
  ...
  return (
    <section id="services" className="px-[5rem] big:px-[10rem]  pt-[4rem] notebook:pt-[6rem]">
      <div className="font-bold text-[2rem]  notebook:text-[3.5rem] pb-[1.5rem]   ">our services</div>
