...
const ContactContainer = () => {
  return (
    <article id="contact" className="  pt-[4rem] notebook:pt-[6rem] notebook:px-[6rem] big:px-[10rem] notebook:pb-[6rem]  flex flex-col notebook:flex-row    justify-center notebook:justify-between ">
